...
function main() {
    ...
    // Verifying matrix multiplication algorithm
    check()
	...
	for(let i=0; i < 5; ++i) {
	    matrix = m3.multiply(matrix, transMat)
	    matrix = m3.multiply(matrix, rotMat)
...
let m3 = {
	...
	return [
	    ...
	    // over the first row of b). I checked an example with check()
	    // above, this performs the usual matrix multiplication on matrixes
	    // that are represented in OpenGL's mode, i.e. transposed. 
